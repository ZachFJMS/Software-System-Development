...
public class RightTriangle extends Shape {
	...
	public double getPerimeter() {
		...
		double Parameter = sideA + sideB + getSideC();
		return Parameter;
	}
	...
	public int getSideC() {
		...
		double sideC =  Math.sqrt(sideA * sideA) + Math.sqrt(sideB * sideB);
		return (int) sideC;
	}
	...
	public void expand(int multiplier) {
		...
		sideA = this.sideA * multiplier;
		sideB = this.sideB * multiplier;
		int sideC = getSideC();
	...
	public void contract(int divisor) {
		...
		sideA = this.sideA / divisor;
		sideB = this.sideB / divisor;
		int sideC = getSideC();
		sideC = sideC / divisor;
	}
